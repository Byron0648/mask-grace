...
class MetaMaskBarlowTwins(nn.Module):
    ...
    def unrolled_backward(self, x1, edge_index_1, x2, edge_index_2, model_optim, mask_optim, eta):
        ...
        # print(z1)
        # print(z2)
        # loss = self.mask_model.loss(z1, z2, batch_size=0)
        loss = self.mask_model.simclr_loss(z1, z2)
        ...
        # loss = self.mask_model_.loss(z1_, z2_, batch_size=0)
        loss = self.mask_model_.simclr_loss(z1_, z2_)
...
if __name__ == '__main__':
    ...
    for epoch in range(1, num_epochs + 1):
        ...
        loss_cl = model.mask_model.simclr_loss(z1, z2)
